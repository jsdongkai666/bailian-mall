...
public class ConsigneeAddressController {
    ...
    public List<BailianConsignee> queryConsigneeAddress(@RequestParam String userId){
    ...
    public String delConsigneeAddress(@RequestParam String consigneeId) {
    ...
    public String addConsigneeAddress(@RequestBody BailianConsignee bailianConsignee) {
    ...
    public String modConsigneeAddress(@RequestBody BailianConsignee bailianConsignee) {
